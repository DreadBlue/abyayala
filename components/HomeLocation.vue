<template>
  <v-container class="pa-0 px-15 pb-5" fluid>
    <v-row>
      <v-col cols="12" class="text-center">
        <span class="color-third text-sm-h3 text-h5">¿COMO LLEGAR?</span>
      </v-col>
    </v-row>
    <v-row>
      <v-col cols="12" sm="5">
      ...
      >
        <h1 class="color-main text-sm-h4 text-h5">TRANSPORTE PÚBLICO</h1>
        <span class="text-sm-body-1 text-body-2">Horarios de Flota Aguila</span>
        <span class="text-sm-body-1 text-body-2">
          Buses directos para Nimaima desde Portal de la 80:
        </span>
        <span class="text-sm-body-1 text-body-2">5:10 am</span>
        <span class="text-sm-body-1 text-body-2">8:50 am</span>
        <span class="text-sm-body-1 text-body-2">4:10 pm</span>
        <h2 class="color-main color-main text-sm-h4 text-h5">¡TE ESPERAMOS!</h2>
      </v-col>
    </v-row>
  </v-container>
</template>
